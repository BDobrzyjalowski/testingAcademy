...
<qml bypassAccessControl="false" caseInsensitive="true" addTimeToDateFields="false" forAdvancedSearch="true" mainType="MMG Position Variant" joinModel="false" xsi:noNamespaceSchemaLocation="qml.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <query>
        <selectOrConstrain distinct="false" group="false">
            ...
            <layoutSectionHeader layoutSectionId="Assembly_Location" text="Demand Location"/>
            <reportAttribute heading="Description" reportAttributeId="Description_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
                <column alias="Demand Location" isExternal="false" type="java.lang.String" propertyName="description">description</column>
            </reportAttribute>
            <reportAttribute heading="DL - Supplier ID" reportAttributeId="Name_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
                <column alias="Organization (wt.org.WTOrganization)" isExternal="false" type="java.lang.String" propertyName="name">name</column>
            </reportAttribute>
            <reportAttribute heading="DL - Plant" reportAttributeId="Plant_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
            ...
            <reportAttribute heading="DL - Plant Key" reportAttributeId="Plant_Key_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
            ...
            <reportAttribute heading="DL - Plant Description" reportAttributeId="Description" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        ...
        <from>
            ...
            <table alias="Demand Location" isExternal="false" xposition="833px" yposition="149px">WCTYPE|com.ptc.windchill.enterprise.data.PlantFunctionalData|com.bmw.psmg.sbb.DemandLocation</table>
            <table alias="In House Production" isExternal="false" xposition="784px" yposition="256px">com.ptc.windchill.suma.supplier.Manufacturer</table>
            <table alias="Organization (wt.org.WTOrganization)" isExternal="false" xposition="423px" yposition="259px">wt.org.WTOrganization</table>
        </from>
        <where>
            <compositeCondition type="or">
                <condition>
                    <standardCondition>
                        <operand>
                            <column alias="Demand Location" isExternal="false" type="long" propertyName="typeInfoPlantFunctionalData.ptc_ref_1.objectId.id">typeInfoPlantFunctionalData.ptc_ref_1.key.id</column>
                        </operand>
                        <operator type="equal"/>
                        <operand>
        ...
        <linkJoin>
            ...
            <join name="com.ptc.windchill.enterprise.data.PlantFunctionalDataMasterIteration">
                ...
                <toAliasTarget alias="Demand Location"/>
            </join>
        </linkJoin>
        <referenceJoin>
            <join name="view">
            ...
            <join name="typeInfoPlantFunctionalData.ptc_ref_1">
                <fromAliasTarget alias="Demand Location"/>
        ...
        <descriptionForExport>This report is used for Related Demand Location Search of Position Variants.</descriptionForExport>
    </query>
</qml>