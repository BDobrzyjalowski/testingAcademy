...
<qml bypassAccessControl="false" caseInsensitive="true" addTimeToDateFields="true" mainType="Workflow Process" joinModel="false" xsi:noNamespaceSchemaLocation="qml.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  <query>
    <selectOrConstrain distinct="false" group="false">
      <reportAttribute heading="Change Task" reportAttributeId="Change_Task_wt_change2_WTChangeActivity2_" userCanSelect="true" userCanConstrain="false" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <object alias="Change Task (wt.change2.WTChangeActivity2)" propertyName=""/>
      </reportAttribute>
      <reportAttribute heading="Change Task.Number" reportAttributeId="Number_1" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Change Task (wt.change2.WTChangeActivity2)" isExternal="false" type="java.lang.String" propertyName="number">master&gt;number</column>
      </reportAttribute>
      <reportAttribute heading="Change Task.Name" reportAttributeId="Name_2" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" constantValue="" isMacro="false">
        <column alias="Change Task (wt.change2.WTChangeActivity2)" isExternal="false" type="java.lang.String" propertyName="name">master&gt;name</column>
      </reportAttribute>
      ...
      <reportAttribute heading="BMW Change Notice.Created" reportAttributeId="Created" userCanSelect="true" userCanConstrain="true" alwaysSelect="false" defaultValue="" defaultOperandValue="THISDAY" constantValue="" isMacro="false">
    ...
    <from>
      ...
      <table alias="Change Task (wt.change2.WTChangeActivity2)" isExternal="false" xposition="151px" yposition="459px">wt.change2.WTChangeActivity2</table>
    </from>
    <where>
    ...
    <linkJoin>
      <join name="wt.change2.IncludedIn2">
        ...
        <toAliasTarget alias="Change Task (wt.change2.WTChangeActivity2)"/>
      </join>
    </linkJoin>
    <referenceJoin>
